...
class TasksFragment : Fragment(), TasksContract.View {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
    ...
    with(root) {
      ...
      val rcvTasks = findViewById<RecyclerView>(R.id.rcvTasks).apply {
  ...
  override fun showNoActiveTasks() {
    showNoTasksViews(resources.getString(R.string.no_tasks_active), R.drawable.ic_check_circle_24dp,
        false)
  }
